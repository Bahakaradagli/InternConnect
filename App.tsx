    ...
    <NavigationContainer>
      {isLoggedIn ? (
        <Stack.Navigator>
          ...
          <Stack.Screen name="Camera" component={MyTournaments}     options={({ navigation }) => ({
              headerShown: true,
              headerTitle: '',
              headerStyle: { backgroundColor: '#000' },
              headerTintColor: '#fff',
              ...
              headerBackground: () => (
                ...
                />
                        ...
                        <Stack.Screen name="ExploreThanksScreen" component={ExploreThanksScreen}  options={({ navigation }) => ({
              headerShown: true,
              headerTitle: '',
              headerLeft: () => (
                <TouchableOpacity
          ...
          />
            <Stack.Screen name="UserProfileScreen" component={UserProfilScreen}  options={({ navigation }) => ({
              headerShown: true,
              headerTitle: '',
              headerLeft: () => (
                <TouchableOpacity
...
<Stack.Screen name="EmegiGecenler" component={EmegiGecenlerScreen}     options={{ headerShown: false }} /> 
  ...
  <Stack.Screen name="SwipeTabs" component={SwipeTabs}         
  options={({ navigation }) => ({
              headerShown: true,
              headerTitle: '',
              headerLeft: () => (
        ...
        <Stack.Navigator screenOptions={{ contentStyle: { backgroundColor: '#121212' } }}>
